...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <>
      <Head>
        {/* Admin pages should not be indexed for security */}
        ...
        {/* Admin-specific meta */}
        <title>Admin Panel - FreeDNS | Secure Management Dashboard</title>
        <meta name="description" content="Secure administrative interface for FreeDNS platform management. Restricted access." />
      </Head>
